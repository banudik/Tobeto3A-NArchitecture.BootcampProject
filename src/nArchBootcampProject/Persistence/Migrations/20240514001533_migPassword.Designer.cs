...
namespace Persistence.Migrations
{
    ...
    [Migration("20240514001533_migPassword")]
    partial class migPassword
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0d89b4ea-f818-45bb-a130-73d263143161"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(2024, 5, 14, 3, 15, 32, 739, DateTimeKind.Local).AddTicks(424),
                            Email = "pair6@pair6.com",
                            FirstName = "Banu",
                            LastName = "Dik",
                            NationalIdentity = "TC1246",
                            PasswordHash = new byte[] { 158, 239, 69, 209, 26, 135, 196, 0, 63, 121, 101, 230, 224, 41, 171, 127, 3, 79, 160, 179, 136, 54, 10, 154, 57, 4, 227, 3, 125, 165, 29, 166, 15, 149, 172, 15, 253, 116, 230, 84, 178, 113, 107, 254, 5, 80, 4, 41, 58, 134, 146, 8, 112, 124, 152, 64, 16, 61, 248, 30, 132, 151, 253, 90 },
                            PasswordSalt = new byte[] { 146, 250, 144, 222, 86, 35, 104, 100, 25, 171, 162, 105, 53, 179, 215, 116, 242, 226, 55, 66, 75, 195, 139, 221, 252, 30, 124, 35, 223, 31, 219, 115, 62, 174, 64, 225, 143, 182, 114, 118, 240, 46, 25, 78, 169, 99, 69, 59, 163, 150, 208, 32, 175, 213, 4, 8, 124, 80, 67, 101, 237, 201, 75, 82, 50, 94, 151, 233, 34, 137, 39, 74, 131, 33, 242, 245, 95, 128, 90, 134, 85, 139, 65, 63, 142, 139, 128, 78, 20, 237, 66, 129, 67, 49, 242, 138, 141, 19, 120, 114, 44, 100, 124, 192, 84, 89, 140, 241, 227, 230, 176, 78, 12, 77, 203, 241, 113, 254, 187, 198, 40, 45, 72, 181, 170, 143, 81, 255 },
                            UserName = "banudik"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("680cdf6d-518b-46fc-ae85-0c02938f3912"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("0d89b4ea-f818-45bb-a130-73d263143161")
                        });
                });
