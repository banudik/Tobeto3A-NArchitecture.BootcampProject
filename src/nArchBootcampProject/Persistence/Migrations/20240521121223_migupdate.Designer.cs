...
namespace Persistence.Migrations
{
    ...
    [Migration("20240521121223_migupdate")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a23cc1e3-9191-4b3d-9b6e-2b3f90ca0a51"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(2024, 5, 21, 15, 12, 23, 460, DateTimeKind.Local).AddTicks(7270),
                            Email = "pair6@pair6.com",
                            FirstName = "Banu",
                            LastName = "Dik",
                            NationalIdentity = "TC1246",
                            PasswordHash = new byte[] { 87, 47, 236, 94, 78, 157, 109, 109, 148, 150, 239, 249, 201, 183, 19, 216, 104, 125, 18, 219, 63, 134, 84, 194, 93, 231, 108, 111, 141, 117, 72, 20, 106, 122, 145, 49, 88, 175, 73, 110, 23, 44, 41, 19, 169, 176, 187, 119, 229, 230, 245, 71, 97, 7, 63, 167, 99, 206, 90, 56, 70, 236, 212, 71 },
                            PasswordSalt = new byte[] { 205, 87, 8, 194, 70, 176, 77, 55, 0, 151, 217, 38, 26, 61, 145, 135, 12, 215, 178, 242, 63, 215, 7, 155, 113, 246, 162, 113, 116, 127, 5, 176, 55, 104, 201, 186, 119, 72, 16, 160, 95, 96, 137, 110, 75, 114, 178, 251, 226, 216, 98, 224, 101, 136, 226, 68, 105, 206, 42, 227, 135, 52, 21, 115, 240, 131, 193, 43, 41, 251, 96, 39, 80, 156, 80, 68, 248, 180, 226, 215, 2, 115, 5, 105, 41, 254, 48, 47, 252, 34, 62, 232, 53, 226, 45, 19, 108, 87, 240, 228, 134, 188, 213, 4, 73, 1, 38, 203, 31, 35, 223, 204, 25, 151, 77, 126, 8, 246, 231, 50, 232, 130, 157, 13, 180, 26, 152, 128 },
                            UserName = "banudik"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("abb2ab40-c41c-47dc-a387-a7ac3e00dcf3"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("a23cc1e3-9191-4b3d-9b6e-2b3f90ca0a51")
                        });
                });
