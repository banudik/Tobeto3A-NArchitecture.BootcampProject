...
namespace Persistence.Migrations
{
    ...
    [Migration("20240425121907_25nisan")]
    partial class _25nisan
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("db0f4ff4-9453-4182-9db3-0e97018ec68f"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateOfBirth = new DateTime(2024, 4, 25, 15, 19, 6, 635, DateTimeKind.Local).AddTicks(8738),
                            Email = "pair6@pair6.com",
                            FirstName = "Banu",
                            LastName = "Dik",
                            NationalIdentity = "TC1246",
                            PasswordHash = new byte[] { 201, 122, 54, 110, 175, 244, 84, 175, 242, 140, 98, 230, 145, 235, 108, 69, 36, 149, 51, 243, 180, 139, 76, 6, 192, 117, 104, 119, 169, 44, 88, 178, 50, 168, 86, 143, 167, 28, 157, 61, 76, 70, 218, 23, 193, 214, 99, 114, 125, 204, 8, 31, 219, 97, 207, 233, 90, 39, 168, 31, 128, 162, 249, 211 },
                            PasswordSalt = new byte[] { 123, 157, 223, 62, 132, 78, 36, 71, 235, 107, 199, 145, 232, 254, 174, 202, 9, 40, 12, 52, 74, 53, 136, 61, 85, 86, 118, 232, 234, 19, 40, 155, 53, 216, 73, 133, 134, 28, 143, 128, 34, 218, 10, 43, 225, 228, 224, 177, 18, 188, 19, 201, 100, 93, 209, 185, 196, 107, 45, 60, 235, 219, 196, 246, 142, 12, 159, 87, 164, 19, 247, 28, 167, 72, 221, 105, 142, 23, 54, 244, 212, 177, 127, 218, 198, 131, 205, 242, 64, 119, 117, 2, 32, 205, 120, 2, 14, 193, 241, 218, 212, 161, 94, 141, 226, 97, 122, 75, 229, 93, 200, 48, 139, 81, 134, 59, 16, 22, 120, 184, 140, 219, 212, 28, 8, 234, 134, 77 },
                            UserName = "banudik"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5699c9df-dcfb-46ca-8e50-154759ee50af"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("db0f4ff4-9453-4182-9db3-0e97018ec68f")
                        });
                });
