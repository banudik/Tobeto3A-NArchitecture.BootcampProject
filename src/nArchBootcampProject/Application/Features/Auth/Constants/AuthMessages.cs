...
public static class AuthMessages
{
    ...
    public const string PasswordResetRequestExpired = "PasswordResetRequestExpired";
    public const string PasswordShouldNotBeSameAsOld = "PasswordShouldNotBeSameAsOld";
